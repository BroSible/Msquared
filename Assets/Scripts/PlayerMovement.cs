...
public class PlayerMovement : MonoBehaviour
{
    ...
    public float playerViewYOffset; // The height at which the camera is bound to
    ...
    public bool holdCtrlToCrouch = false; 
    ...
    private void QueueCrouch()
    {
        ...
        if(Input.GetKeyDown(KeyCode.LeftControl) && !wishCrouch && !holdCtrlToCrouch)
        {
            wishCrouch = true;
        }

        else if(Input.GetKeyDown(KeyCode.LeftControl) && wishCrouch)
        {
            wishCrouch = false;
        }

        if(Input.GetKeyUp(KeyCode.LeftControl) && holdCtrlToCrouch)
        {
            wishCrouch = false;
        }
    }
